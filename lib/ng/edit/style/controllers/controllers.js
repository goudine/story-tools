(function() {
    ...
    module.controller('styleEditorController', 
        function($rootScope, $scope, stStyleTypes, stStyleChoices, stLayerClassificationService, stStyleRuleBuilder) {
            var styles = {};
            ...
            // $rootScope.$on("broadcastHasStarted", function() {
            //     console.log("listener has heard the broadcast!!!!");
            //     setTimeout( function () {
            ...
            // $rootScope.$on(myVariable, function(event, data) { 
            //     console.log(data);
